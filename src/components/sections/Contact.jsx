...
export default function Contact() {
  return (
    <section id="contact" className="scroll-mt-28 py-10 sm:py-12" aria-labelledby="contact">
      <div className="space-y-6">
        ...
        <div className="grid gap-6 sm:grid-cols-[minmax(0,2fr)_minmax(0,1.3fr)]">
          ...
          <div className="space-y-3 rounded-2xl border border-slate-200 bg-slate-100/60 p-4 text-sm dark:border-slate-800 dark:bg-slate-900/60">
            <div>
